...
MD5::MD5(const string& str) : input_msg(str) {}

void MD5::init() {
    // init the binary message
    bin_msg.clear();
    for (std::size_t i = 0; i < input_msg.size(); ++i) {
        auto temp = bitset<8>(input_msg[i]);
